...
const NewBookDisenoGrafico = () => {
    const [libro, setLibro] = useState({
        ...
        imagen: "",
        url: "",
        seccion: "librosDisenoGrafico"
      });

  const {setBook} = useDisenoGrafico();
  ...
  return (
    <>
        <div className='form-base mx-auto my-12 self-center'>
          ...
          <h3 className='mt-3 mb-6 font-bold text-lg text-center'>Nuevo Libro de Diseño Grafico</h3>
...
export default NewBookDisenoGrafico
